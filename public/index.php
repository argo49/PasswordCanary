<!DOCTYPE html><!--[if lt IE 7]><html class="no-js lt-ie10 lt-ie9 lt-ie8 lt-ie7"> <![endif]--><!--[if IE 7]><html class="no-js lt-ie10 lt-ie9 lt-ie8"> <![endif]--><!--[if IE 8]><html class="no-js lt-ie10 lt-ie9"> <![endif]--><!--[if IE 9]><html class="no-js lt-ie10"> <![endif]--><html><head><title>PasswordCanary</title><meta name=viewport content="width=device-width, initial-scale=1"><script type=text/javascript>function loadCSS(a,b,c){"use strict";var d=window.document.createElement("link"),e=b||window.document.getElementsByTagName("script")[0];d.rel="stylesheet",d.href=a,d.media="only x",e.parentNode.insertBefore(d,e),setTimeout(function(){d.media=c||"all"})}function loadJS(a){"use strict";var b=window.document.getElementsByTagName("script")[0],c=window.document.createElement("script");return c.src=a,b.parentNode.insertBefore(c,b),c}loadCSS("https://fonts.googleapis.com/css?family=Lato:300,400,700"),loadCSS("http://fonts.googleapis.com/css?family=Trocchi"),loadCSS("http://fonts.googleapis.com/css?family=Special+Elite"),loadCSS("css/styles.css"),loadJS("js/scripts.js");</script></head><body><div class=container><div class="row clearfix title"><div class="column full"><h1 class=title>PasswordCanary <img class=logo height=64px width=64px src=images/canary.svg></h1></div></div><div class="row clearfix email"><div class="column full"><form><label for=email>Enter the email address that is associated to the account(s) you wish to monitor.</label><div><input class=input id=email name=email type=text placeholder=Email><button class=email type=submit>Warn Me</button></div></form></div></div><div class="row clearfix flip"><div class="column full"><h2>Compromised Email Addresses (<span class=counter></span>)</h2><div class=email-wrapper></div></div></div><div class="row clearfix"><div class="column full"><h2>About this Site</h2><p>Often times when databases are compromised, usernames, emails and passwords are taken from these databases and put on different websites and forums for everyone to see. We monitor these website to see if your email pops up, and we'll send you an email if that happens.</p></div></div></div><div class=modal><div class=content><h2>We'll now notify <span></span> if we see that address show up publicly.</h2><h3>Have a Yo account? Get notified through Yo:</h3><form><input class=input id=yo name=yo type=text placeholder="Yo Username"><button type=submit>Warn Me Through Yo</button></form></div></div><script type=text/javascript src=js/jquery-1.11.1.min.js></script><script type=text/javascript src=js/moment.min.js></script><script type=text/javascript>
        ...
        $(document).ready(function () {
            ...
            emailButton.on('click', function(event) {
                event.preventDefault();
                var emailAddr = emailForm.find('input').val();
